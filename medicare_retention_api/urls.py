...
from medicare_retention_api.auth_views import (
    ...
    proxy_eob,
    proxy_fhir,
    proxy_medication_dispense,
    proxy_medication_request,
...
urlpatterns = [
    ...
    path("api/fhir/medicationrequest/", proxy_medication_request),
    path("api/fhir/medicationstatement/", proxy_medication_statement),
    path("api/fhir/medicationdispense/", proxy_medication_dispense),
    path("api/fhir/claim/", proxy_claim),
